from fraud_detection.entity.config_entity import ModelEvaluationConfig, LocalModelEvaluationConfig, DataTransformationConfig
from fraud_detection.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact,LocalModelEvaluationArtifact
from sklearn.metrics import f1_score
from fraud_detection.exception import ExceptionHandle
from fraud_detection.constants import TARGET_COLUMN, CURRENT_YEAR, SCHEMA_FILE_PATH
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[FraudDetectionEstimator]:
        """
        ...
        try:
            ...
            FraudDetection_estimator = FraudDetectionEstimator(bucket_name=bucket_name,
