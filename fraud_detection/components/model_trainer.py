...
from fraud_detection.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from fraud_detection.entity.config_entity import ModelTrainerConfig
from fraud_detection.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            fraud_detection_model = FraudDetectionModel(preprocessing_object=preprocessing_obj,
                                       trained_model_object=best_model_detail.best_model)
            logging.info("Created fraud detectionmodel object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, fraud_detection_model)
